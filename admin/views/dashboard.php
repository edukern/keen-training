...
<div class="wrap kt-wrap">
	...
	// Frases padrão centralizadas em KT_Frontend::default_quotes()
	$_default_staff   = KT_Frontend::default_quotes( 'staff' );
	$_default_manager = KT_Frontend::default_quotes( 'manager' );
